...
![Image](./images/login_data_sqlite.PNG)
...
![Image](./images/HBP_chrome_example.PNG)
...
![Image](./images/HBP_firefox_example.PNG)

Decryption using non-standard master password
![Image](./images/HBP_firefox_masterpassword_example.PNG)

# Other Examples

Collecting Chrome and Firefox credentials and outputting both to the console
![Image](./images/HBP_all_example.PNG)

Writing output to CSV
![Image](./images/HBP_all_csv_example.PNG)
